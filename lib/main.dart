...
class _ManageUserProfileScreenState extends State<ManageUserProfileScreen> {
    ...
    try {
      ...
      if (doc.exists) {
        ...
        setState(() {
          ...
          selectedJob = data['interestedJob'] ?? 'Mobile App Developer';
          profileExists = true;
        });
      }
    } catch (e) {
  ...
  Future<void> saveProfile() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(profileExists ? 'Profile updated' : 'Profile saved'),
        ),
      );
    } catch (e) {
      print('Save error: $e');
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    resumeSection(
                      title: 'Skills',
                      content: data['skillSet'] ?? '',
                    ),

                    resumeSection(
                      title: 'Career Objective',
                      content:
                          'Motivated and passionate ${data['interestedJob']} seeking opportunities to grow professionally and contribute technical skills to innovative projects.',
                    ),
    ...
    return Scaffold(
      ...
      body: FutureBuilder<DocumentSnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          final interestedJob = data['interestedJob'] ?? 'Mobile App Developer';
